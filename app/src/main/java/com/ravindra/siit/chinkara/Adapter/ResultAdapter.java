...
//    LayoutInflater layoutInflater;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ConstraintLayout constraintLayout = convertView.findViewById(R.id.constraintLayoutResultRow);
...
//                    option4.setBackgroundColor(context.getResources().getColor(R.color.wrongAns));
        ...
        if (position==0||position%2==0){
            constraintLayout.setBackgroundColor(context.getResources().getColor(R.color.result_row_color));
        }
        else
        {
            constraintLayout.setBackgroundColor(context.getResources().getColor(R.color.result_row_color2));
